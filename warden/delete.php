...
<body>
    ...
    if($warden_hostel != "St Thomas Block") {
        $st_thomas_disabled = "disabled";
    }
    if($warden_hostel != "Annex Block") {
        $annex_disabled = "disabled";
    }
    if($warden_hostel != "Chacko Block") {
        $chacko_disabled = "disabled";
    }
?>
    ...
    <option value="St Thomas Block" <?php echo $st_thomas_disabled; ?> <?php if(isset($_POST['hostel']) && $_POST['hostel'] == 'St Thomas Block') { echo ' selected'; } ?>>St Thomas Hostel</option>
    <option value="Annex Block" <?php echo $annex_disabled; ?> <?php if(isset($_POST['hostel']) && $_POST['hostel'] == 'Annex Block') { echo ' selected'; } ?>>Annex Hostel</option>
    <option value="Chacko Block" <?php echo $chacko_disabled; ?> <?php if(isset($_POST['hostel']) && $_POST['hostel'] == 'Chacko Block') { echo ' selected'; } ?>>Chacko Hostel</option>
		</select>
