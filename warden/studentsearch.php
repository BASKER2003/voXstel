...
<div class="wrapper">
	<div class="search_box">
		<input type="text" name="regno" id="regno" class="input_search" placeholder="Enter student regno" pattern="[0-9]{2}[a-z]{2,3}[0-9]{2,3}">
    <div class="search_btn"><input class="btn" id="find" type="submit" name="submit" value="find"> </div>
<!--
...
<tbody>
  ...
  $sql="SELECT name,regno,email,phoneno,block,roomno FROM users WHERE `regno` ='$regno' and `block` = '$warden_hostel' ;";
...
recognition.onend = () => {
  ...
  else if (speechInput.includes("find")) 
  {
