...
<div class="wrapper">
   ...
   <div class="content">
      <!-- card -->
      <div class="card" onclick="hosteldetails()">
      ...
      <div class="card" onclick="requests()">
            ...
            <div class="icon"><i class="material-icons md-36">rule</i></div>
            <p class="title">Leave Status</p>
            <p class="text">See leave statuses</p>
...
<p class="title">Update Passowrd</p>
<p class="text">update your password</p>
...
<div class="icon"><i class="material-icons md-36">report</i></div>
<p class="title">Complaint Request</p>
<p class="text">complaint From Students</p>
...
recognition.onend = () => {
  ...
  else if (speechInput.includes("complaint request"))
  {
    console.log('Detected keyword : '+ speechInput.toLowerCase());
    complaint();
  }
