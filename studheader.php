  ...
  <link rel="stylesheet" href="https://fonts.googleapis.com/css2?family=Material+Symbols+Outlined:opsz,wght,FILL,GRAD@20..48,100..700,0..1,-50..200" />
    ...
    *{
    ...
    <script type="text/javascript">
      ...
      function showstatus()
      {
        window.location.href ="../student/showstatus.php";
      }
    </script>
  </head>
  ...
  <body>
    ...
    <div class="Nav" id="Nav1">
      <div class="NavbarContainer">
        <img src="..\images\kcglogo.png" alt="KCG" class="NavLogo" onclick="rtohome()">
        <div class="MobileIcon">
        <i class="fa fa-bars"></i>
        </div>
    <ul class="NavMenu ">
      <li style="color:white;padding-top:30px; margin-left:250px;" class="NavItem"><?php echo "Welcome $regno"; ?></li>
      <div id="notification-icon"  onclick="showstatus()">
        <li style="color:white;padding-top:0px;margin-left:70px " class="material-symbols-outlined">notifications</li>
      </div>
    </ul>
        <!-- <ul class="NavMenu ">
        ...
        <div class="NavBtn">
          <button type="button" name="button" class="NavBtnLink" onclick="rtohome()">Home</button>
        </div>

        <div id="sp" onclick="speechInput()">
