...
<?php include 'header1.php'; ?>
    ...
    <br />
		<div class="row">
			<div class="col-sm">
				<button type="button" id="thomas" class="btn btn-primary" onclick="showStudents('St Thomas Block')">St Thomas hostel for boys</button>
			</div>
			<div class="col-sm">
				<button type="button" id="annex" class="btn btn-primary" onclick="showStudents('Annex Block')">Annex hostel for boys</button>
			</div>
			<div class="col-sm">
				<button type="button" id="chacko" class="btn btn-primary" onclick="showStudents('Chacko Block')">Chacko hostel for girls</button>
			</div>
		</div>
		<div class="row mt-3">
			<div class="col-sm">
...
recognition.onend = () => {
  ...
  else if (speechInput.includes("st thomas hostel"))
  {
    ...
    var Btn = document.getElementById("thomas");
    Btn.click();
  }
  ...
  {
    console.log('Detected keyword : '+ speechInput.toLowerCase());
    var Btn = document.getElementById("chacko");
    Btn.click();
  }
