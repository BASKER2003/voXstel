...
<body>
  ...
  $room_query = "SELECT * FROM thomas WHERE room_no='$room_no'";
  ...
  if(isset($_POST['bed_no']) && isset($_POST['room_no'])) 
  {
    ...
    $update_room_query = "UPDATE thomas SET available=available-1 WHERE room_no='$room_no'";
